...
public class RSA_Enkripcija {
    ...
    public RSA_Enkripcija(BigInteger D, int e, BigInteger N) {
        this.D = D;
        this.e = e;
        this.N = N;
    }

    private BigInteger enkriptiraj() {
    ...
    private int getBlockLenght(BigInteger broj) {

...
public class RotorObrnuto1 {
    ...
    public static char rotorObrnuto1(int slovo, int pomakRotora) { //slovo je broj od 0-25, a pomak rotora je trenutni pomak rotora od početka (dio ključa broj 0 - 25),

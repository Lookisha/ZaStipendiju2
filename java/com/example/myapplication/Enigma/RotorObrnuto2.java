...
public class RotorObrnuto2 {
    ...
    public static int rotorObrnuto2(int slovo, int pomakRotora) { //slovo je broj od 0-25, a pomak rotora je trenutni pomak rotora od početka (dio ključa broj 0 - 25),
        ...
        pomaci.add(0,1); //index predstavlja broj slova, a element pomak
        pomaci.add(1,-1);
        pomaci.add(2,2);
        pomaci.add(3,8);
        pomaci.add(4,17);

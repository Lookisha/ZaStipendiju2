...
public class RotorObrnuto3 {
    ...
    public static int rotorObrnuto3(int slovo, int pomakRotora) { //slovo je broj od 0-25, a pomak rotora je trenutni pomak rotora od početka (dio ključa broj 0 - 25),
        ...
        pomaci.add(0,6); //index predstavlja broj slova, a element pomak
        pomaci.add(1,4);
        pomaci.add(2,13);
        pomaci.add(3,18);
        pomaci.add(4,-3);
